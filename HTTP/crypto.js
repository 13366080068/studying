...
// 不管内容有多少 ，摘要出的结果 永远长度相同,相同的内容多次摘要的结果肯定相同
...
let data1 = fs.readFileSync(path.resolve(__dirname, 'index.html')).slice(0, 50)
let data2 = fs.readFileSync(path.resolve(__dirname, 'index.html')).slice(50)
