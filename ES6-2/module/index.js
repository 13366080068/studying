...
// 1. 我们可以一一列举获取 2. 可以用 * as 3. 给接口取名
// 3. 我们可以通过 接口名 获取最新接口对应的值

// import { str, str1, str2 } from './a' // 如果一个个导出的 我可以一个个的拿出来用
...
//                  import { default as str } from './xxx'
...
// vue 代码出了入口文件 其他的都是export function(){}
