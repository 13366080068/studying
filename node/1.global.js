...
// this默认在文件中并不是global
// node模块化的概念 模块化如何实现？ 函数它里面的this被更改了
// (function() {
//   console.log(this == global)
// })()

// require module exports __dirname __filename 文件中可以直接使用以上五个参数，它是文件外套的函数的参数
...
// 怎么获取执行时传递的参数
// console.log(process.argv.slice(2)) // 需要拿到用户传入的参数，从第2个参数之后才是结果

// let options = process.argv.slice(2).reduce((memo, current, index, arr) => {
//   if (current.startsWith('--')) memo[current.slice(2)] = arr[index+1]
//   return memo
// }, {})
// console.log(options)
...
//   console.log('Use Delete Command')
// })
// program.command('mkdir').action(function() {
//   console.log('Use Add Command')
// })
// program.option('--help', function() {
//   console.log('\r\n run command ---------------')
// })
...
// 实现了一个模块化 commonjs规范 产生一个函数将代码放到函数中 保证每个文件
